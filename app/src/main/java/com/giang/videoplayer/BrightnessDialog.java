...
public class BrightnessDialog extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        cross = view.findViewById(R.id.brtClose);
        brightNo = view.findViewById(R.id.brtNumber);
        seekBar = view.findViewById(R.id.brtSeekbar);

        int brightness = Settings.System.getInt(getContext().getContentResolver(),
                Settings.System.SCREEN_BRIGHTNESS, 0);
        brightNo.setText(brightness + "");
